...
LstmNet = LstmModel().to(device)
criterion = torch.nn.MSELoss(reduction="mean")
optimizer = torch.optim.Adam(params=LstmNet.parameters(), lr=learning_rate, weight_decay=weight_decay)
...
plt.legend()
plt.savefig("prediction_lstm.svg", format='svg')
plt.show()